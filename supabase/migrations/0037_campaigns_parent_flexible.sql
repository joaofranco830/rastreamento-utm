-- =============================================================================
-- 0037_campaigns_parent_flexible.sql — navegação fluida na Tela Campanhas.
--
-- Torna o filtro de "pais" flexível: p_parent_ids pode conter meta_ids de
-- CAMPANHAS ou de CONJUNTOS. Assim, selecionando campanhas e clicando na aba
-- "Anúncios" abre os anúncios dessas campanhas (drill igual ao gerenciador),
-- e conjuntos selecionados filtram anúncios normalmente. Só muda o WHERE do
-- ad_ent; resto idêntico ao 0036.
-- =============================================================================
